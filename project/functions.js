var functions_d6ad677b_427a_4623_b50f_a445a3b0ef8a = 
{
	...
	*/
	...
	if (!core.domStyle.isVertical) {
		...
		// 绘制攻击
		//core.drawImage(ctx, core.statusBar.icons.atk, 3, 94, 16, 16);
		if (core.getFlag('jd', 0) >= 2) { _fillBoldTextWithFontCheck(('阶层:' + core.formatBigNumber((core.getFlag('jc', 0))) + "(" + core.formatBigNumber((core.getFlag('jcjy', 0))) + ")"), 60, 165, '#FFEF00'); } else { _fillBoldTextWithFontCheck(('未解锁'), 245, 72, '#FFEF00') }
